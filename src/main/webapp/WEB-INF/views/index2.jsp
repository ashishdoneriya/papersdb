...
/* 		var cb = function() {
		...
		function getRow(paper) {
			...
			if (paper.month != null ) {
				...
				row += '<td data-title="Date"></td>';
			}
			row += '<td data-title="Download Link"><a onclick="increaseCounter(' + paper.paperID + ')" href="' + paper.path + '"><span class="glyphicon glyphicon-download-alt"></span> Download</a</td></tr>';
			return row;
		}
